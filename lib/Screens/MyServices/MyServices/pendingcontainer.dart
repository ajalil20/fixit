...
class PendingContainer extends StatefulWidget {
  ...
  PendingContainer({required this.serviceicon, required this.servicetype,required this.servicetitle,required this.location,required this.servicetime,required this.timeposted,required this.clientbudget});
  @override
